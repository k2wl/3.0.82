...
struct kona_freq_tbl kona_freq_tbl[] = {
	...
	FTBL_INIT(1200000, PI_PROC_OPP_TURBO),
        ...
        FTBL_INIT(104000, PI_PROC_OPP_TURBO),
	FTBL_INIT(156000, PI_PROC_OPP_ECONOMY1),
        FTBL_INIT(260000, PI_PROC_OPP_TURBO),
	FTBL_INIT(312000, PI_PROC_OPP_ECONOMY1),
        FTBL_INIT(416000, PI_PROC_OPP_ECONOMY1),
        FTBL_INIT(520000, PI_PROC_OPP_NORMAL),
	FTBL_INIT(676000, PI_PROC_OPP_NORMAL),
	FTBL_INIT(832000, PI_PROC_OPP_TURBO1),
	FTBL_INIT(936000, PI_PROC_OPP_TURBO1),
	FTBL_INIT(1040000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1200000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1248000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1248000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1326000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1404000, PI_PROC_OPP_TURBO),
#else
	FTBL_INIT(312000, PI_PROC_OPP_ECONOMY1),
